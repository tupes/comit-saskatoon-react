...
async function updateTopScoresOnFirebase(topScoresArray) {
...
export default function TopScoresMemo() {
    ...
    return(
        <div className="div-topscores-container">
            ...
            <button id="button_update_firebase" onClick={() => updateTopScoresOnFirebase(topScoresArray)} type="button">Update to Firebase</button> 
        </div> 
    )
} 
